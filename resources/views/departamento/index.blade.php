                            ...
                            <table class="table table-striped table-hover">
                                <thead class="thead">
                                    <tr>
										...
										<th>Edificio Id</th>
										<th>Nro Of Departamento</th>
										<th>Nro Of Habitaciones</th>
										<th>Piso</th>
                                ...
                                <tbody>
                                    @foreach ($departamentos as $departamento)
                                        <tr>
											...
											<td>{{ $departamento->edificio_id }}</td>
											<td>{{ $departamento->nro_of_departamento }}</td>
											<td>{{ $departamento->nro_of_habitaciones }}</td>
